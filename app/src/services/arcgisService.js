...
class ArcgisService {
    ...
    static getMaxDateFromHistograms(counts) {
        ...
        let date = new Date(beginDate.getTime() + ((daysFromStartYear ) * 24 * 60 * 60 * 1000));
        logger.debug('Year', year, 'beginData', beginDate.toISOString(), 'daysFromStartYear', daysFromStartYear, 'Final date', date.toISOString());
        return date;
    }
